...
<?php } elseif ($module == 'Administration') { ?>
	<ul class="nav nav-list">
		...
		<li class="">
			...
			<ul class="submenu">
			<?php if (array_search("add-marchant", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
					<li class="">
						<a href="<?php echo base_url(); ?>add-marchant">
							<i class="menu-icon fa fa-caret-right"></i>
							Marchant/Wholeseller Create
						</a>
						<b class="arrow"></b>
					</li>
				<?php endif; ?>
				<?php if (array_search("marchant-approve-page", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
					<li class="">
						<a href="<?php echo base_url(); ?>marchant-approve-page">
							<i class="menu-icon fa fa-caret-right"></i>
							Marchant/Wholeseller List
						</a>
						<b class="arrow"></b>
					</li>
				<?php endif; ?>
	...
	<ul class="nav nav-list">
		...
		<?php if (array_search("admin-order-hold", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>admin-order-hold">
					<i class="menu-icon fa fa-usd"></i>
					<span class="menu-text">Hold Order  </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (array_search("marchant-approve-page", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>marchant-approve-page">
					<i class="menu-icon fa fa-usd"></i>
					<span class="menu-text">Marchant/W-seller  </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
