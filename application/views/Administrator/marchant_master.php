...
<div class="user-logo  position-relative " onclick='profile()'>
    ...
    <ul class="header-right-toggle position-absolute">
        <p class="text-white toggle-username">{{Auth::user()->name}}</p>
        <li><a href="#"><i class="fas fa-user me-1"></i> Profile</a></li>
        <li><a href="#"><i class="fas fa-wrench me-1"></i> Changer Password</a></li>
        <li><a href="" onclick="return confirm('Are you sure! Logout from dashboard.')"><i class="fas fa-sign-out-alt text-warning me-1"></i> Logout</a></li>
    </ul>
</div>
</nav>
    <div class="main">
   ...
   <nav class="sidebar custom-sidebar py-2 mb-4">
       <ul class="nav flex-column" id="nav_accordion">
           ...
           <li class="nav-item li-item">
               <a class="nav-link a-link" href="#"><i class="fa-solid fa-square-check icon"></i> Number of Complete </a>
           </li>
           <li class="nav-item li-item">
               <a class="nav-link a-link" href="#"><i class="fa-brands fa-accessible-icon icon"></i> Number of Processing </a>
           </li>
           <li class="nav-item li-item">
               <a class="nav-link a-link" href="#"><i class="fa-solid fa-hand-holding icon"></i> Number of Hold </a>
           </li>
           <li class="nav-item li-item">
               <a class="nav-link a-link" href="#"><i class="fa-solid fa-ban icon"></i> Number of Cancel </a>
           </li>
         
          
           <li class="nav-item li-item has-submenu">
               <a class="nav-link a-link d-flex " href="#"><i class="fa-solid fa-user icon my-auto"></i><span class="my-auto"> User</span> <i class="fa-solid fa-angle-down down-icon my-auto ms-auto"></i>  </a> 
               <ul class="submenu collapse ">
                   <li><a class="nav-link a-link  " href=""> <i class="fa-brands fa-first-order icon"></i> User Role</a></li>
                   <li><a class="nav-link a-link " href=""><i class="fa-solid fa-user-group icon"></i> User Create</a></li>
           ...
           <li class="nav-item li-item has-submenu">
               ...
               <ul class="submenu collapse ">
                   <li><a class="nav-link a-link  " href=""> <i class="fa-brands fa-first-order icon"></i> Supplier</a></li>
           ...
           <li class="nav-item li-item">
               <a class="nav-link a-link" href="#" onclick="return confirm('Are you sure! Logout from dashboard.')"><i class="fa-solid fa-right-from-bracket icon"></i> logout </a>
           </li>
       </ul>
       </nav>
</div>
