    ...
    <div class="row" id="accessRow">
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="sales">
                    <li><input type="checkbox" class="access" value="order_complete" v-model="access">Order Complete</li>
                    <li><input type="checkbox" class="access" value="order_hold" v-model="access">Order Hold</li>
