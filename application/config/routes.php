...
// routes created shamim
$route['admin-get-category'] = 'Administrator/Products/getCategories';
$route['admin-get-product/(:any)'] = 'Administrator/Products/getAdminProduct/$1';
...
//admin order related routes created shamim's
$route['admin-order-hold'] = 'Administrator/Sales/orderHold';
$route['admin-get-hold-order'] = 'Administrator/Sales/getOrderHold';
$route['admin-get-complete-order'] = 'Administrator/Sales/getOrderComplete';
$route['admin-get-process-order'] = 'Administrator/Sales/getOrderProcess';
$route['admin-get-cancel-order'] = 'Administrator/Sales/getOrderCancel';
$route['admin-hold-order-update/(:any)'] = 'Administrator/Sales/getOrderHoldUpdate/$1';
$route['admin-process-order-update/(:any)'] = 'Administrator/Sales/getOrderProcessUpdate/$1';
$route['admin-hold-order-delete/(:any)'] = 'Administrator/Sales/getOrderHoldDelete/$1';
$route['admin-order-details/(:any)'] = 'Administrator/Sales/getOrderDetails/$1';
$route['admin-order-complete'] = 'Administrator/Sales/orderComplete';
$route['admin-order-process'] = 'Administrator/Sales/orderProcess';
$route['admin-order-cancel'] = 'Administrator/Sales/orderCancel';
...
$route['add-marchant'] = 'Administrator/Marchant/addMarchant';
$route['get-marchant-wholeseller'] = 'Administrator/Marchant/getMarchantWholeseller';
$route['marchant-store'] = 'Administrator/Marchant/marchantStore';
$route['marchant-delete/(:any)'] = 'Administrator/Marchant/marchantDelete/$1';
$route['marchant-approve-page'] = 'Administrator/Marchant/approvePage';
$route['get-all-marchant'] = 'Administrator/Marchant/getAllMarchant';
$route['approve/(:any)'] = 'Administrator/Marchant/approve/$1';
$route['image-zip/(:any)'] = 'Administrator/Products/imageZip/$1';
...
$route['get-processing-order'] = 'Marchant/Order/getProcessingOrder';
$route['complete-order'] = 'Marchant/Order/completeOrder';
$route['get-complete-order'] = 'Marchant/Order/getCompleteOrder';
$route['cancel-order'] = 'Marchant/Order/cancelOrder';
$route['get-cancel-order'] = 'Marchant/Order/getCancelOrder';
$route['get-order-details/(:any)']	=	'Marchant/order/getOrderDetails/$1';

$route['user-login'] = 'Marchant/MarchantLogin/login';
$route['customer-logout'] = 'Marchant/MarchantLogin/logout';
$route['marchant-registration'] = 'Marchant/MarchantLogin/registraion';
$route['marcahnt-registration-store'] = 'Marchant/MarchantLogin/registraionStore';
$route['wholeseller-registration'] = 'Marchant/MarchantLogin/wholeRegistraion';
$route['wholeseller-registration-store'] = 'Marchant/MarchantLogin/wholeRegistraionStore';
$route['number-check'] = 'Marchant/MarchantLogin/numberCheck';
$route['customer-check'] = 'Marchant/MarchantLogin/loginCheck';

$route['password-change'] = 'Marchant/Profile/passwordChange';
$route['password-update'] = 'Marchant/Profile/passwordUpdate';
$route['user-profile'] = 'Marchant/Profile/profile';
$route['get-profile-data/(:any)'] = 'Marchant/Profile/getProfileData/$1';
$route['profileUpdate'] = 'Marchant/Profile/profileUpdate';


$route['marchant-get_categories'] = 'Marchant/ProductController/getCategories'; 
